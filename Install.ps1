...
if($bridgeManifest.version -ne '0.18.1' -or !$bridgeManifest.files){throw 'Invalid release manifest'}
...
$bridgeInstall=Join-Path $bridgeInstallBase ('versions\0.18.1-'+$bridgeHash)
