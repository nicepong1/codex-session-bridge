...
if($bridgeManifest.version -ne '0.19.0' -or !$bridgeManifest.files){throw 'Invalid release manifest'}
...
$bridgeInstall=Join-Path $bridgeInstallBase ('versions\0.19.0-'+$bridgeHash)
