...
if($bridgeManifest.version -ne '0.19.2' -or !$bridgeManifest.files){throw 'Invalid release manifest'}
...
$bridgeInstall=Join-Path $bridgeInstallBase ('versions\0.19.2-'+$bridgeHash)
