...
**[설치 파일 다운로드](https://github.com/nicepong1/codex-session-bridge/releases/tag/v0.19.6)** · **[사용설명서](docs/USER-GUIDE.md)** · **[문제 해결](docs/TROUBLESHOOTING.md)** · **[앱 개요와 구조](docs/OVERVIEW.md)**
...
**옵션 선택기·일부 초기 설정, 브라우저·계정 인증, 플러그인 설치 제안, 파일 선택 폼, 계획 편집본 실행·닫기는 호스트 공식 앱에서 처리해야 합니다.** 대기 메시지 추가·실행, 실행 중 중지·개입, 첨부파일·원격 파일/터미널 패널도 미지원입니다. 자세한 범위와 실제 화면 검증 여부는 [승인·질문 지원표](docs/APPROVALS.md)를 참고하세요.
