...
if(!$bridgeTarget.StartsWith($bridgeBase,[StringComparison]::OrdinalIgnoreCase) -or [IO.Path]::GetFileName($bridgeTarget) -notmatch '^0\.19\.0-[a-f0-9]{12}$'){throw 'Run Uninstall.ps1 from the installed version directory.'}
