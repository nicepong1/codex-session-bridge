...
const report={bridgeVersion:'0.18.2',platform:process.platform,architecture:process.arch,appVersions:desktop.versions??[],appCompatible:desktop.testedBuild===true,cliCompatible:false,ipcReady:false};
