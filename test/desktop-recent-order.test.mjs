...
const rows = ids.map((id,i) => ({id, title: i < 2 ? 'Mindmap' : 'Samwoo-ERP', updatedAt: 1788776111, createdAt: 1788776111}));
test('desktop recent sorting matches mobile file-list order across equal timestamps and pages', () => {
...
test('individual hydration retains file-list metadata without touching the actual conversation', () => {
  ...
  assert.equal(newer.updatedAt,1788776200); assert.equal(newer.recencyAt,1788776200);
});
